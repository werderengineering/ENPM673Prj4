...
def main(prgRun):
    ...
    if problem == 1:
        ...
        fr.LKRegisteration(frames, template, rect, rotate=False, his=False, numberOfiteration=1000, delta_p_threshold=0.1)  # rect update
    ...
    if problem == 3:
        ...
        fr.LKRegisteration(frames, template, rect, rotate=False, his=False, numberOfiteration=4000, delta_p_threshold=0.15)  # rect update
